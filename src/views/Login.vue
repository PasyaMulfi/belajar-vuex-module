                ...
                <div class="flex-auto p-6">
                    ...
                    <div class="mb-10 flex flex-shrink-0 flex-grow-0 items-center justify-center overflow-hidden">
                        <a href="#"
                            ...
                            <span
                                class="flex-shrink-0 text-3xl font-black lowercase tracking-tight opacity-100">Vondutch</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    <h4 class="mb-2 font-medium text-gray-700 xl:text-xl">Welcome to Vondutch!</h4>
                    ...
                    <form id="" class="mb-4" @submit.prevent="performLogin">
                        <div class="mb-4">
                            ...
                            <input type="text"
                                ...
                                id="email" v-model="username" required placeholder="Enter your email or username" autofocus="" />
                        </div>
                        <div class="mb-4">
