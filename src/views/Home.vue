    ...
    <div id="app">
        <div class="container mx-auto sm:px-4" style="padding-top: 20px">
            <div class="grid grid-rows-4 grid-flow-col gap-6">
                <div class="col">
                    ...
                    <div class="py-3 px-6 mb-0 bg-gray-200 border-b-1 border-gray-300 text-gray-900">
                        ...
                        <div class="flex-auto p-6">
                            ...
                            <div class="mb-4">
                                <button 
                                class="inline-block-align-middle text-center text-white select-none border font-normal whitespace-no-wrap rounded no underline bg-blue-600 py-1 px-2 leading-tight text-xs"
                ...
                <div class="col">
                    <div
                    class="relative flex flex-col min-w-0 rounded break border bg-white order-1 border-gray-300">
                    <div class="py-3 px-6 mb-0 bg-gray-200 border-b-1 border-gray-300 text-gray-900">
